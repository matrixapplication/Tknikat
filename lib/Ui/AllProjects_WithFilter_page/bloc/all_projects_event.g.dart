...
part of 'all_projects_event.dart';
...
class _$GetAllProjects extends GetAllProjects {
  @override
  final CustomFilter customFilter;

  factory _$GetAllProjects([void Function(GetAllProjectsBuilder)? updates]) =>
      (new GetAllProjectsBuilder()..update(updates))._build();

  _$GetAllProjects._({required this.customFilter}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        customFilter, r'GetAllProjects', 'customFilter');
  }

  @override
  GetAllProjects rebuild(void Function(GetAllProjectsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GetAllProjectsBuilder toBuilder() =>
      new GetAllProjectsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetAllProjects && customFilter == other.customFilter;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetAllProjects')
          ..add('customFilter', customFilter))
        .toString();
  }
}

class GetAllProjectsBuilder
    implements Builder<GetAllProjects, GetAllProjectsBuilder> {
  _$GetAllProjects? _$v;
  ...
  GetAllProjectsBuilder();

  GetAllProjectsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(GetAllProjects other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GetAllProjects;
  }

  @override
  void update(void Function(GetAllProjectsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GetAllProjects build() => _build();
