...
import '../logic/service_order_cubit.dart';
import 'package:timeago/timeago.dart' as timeago;

class MyServiceOrdersBody extends StatefulWidget {
  final bool isProvider;
  const MyServiceOrdersBody({super.key,required this.isProvider});

  @override
  State<MyServiceOrdersBody> createState() => _MyServiceOrdersBodyState();
}

class _MyServiceOrdersBodyState extends State<MyServiceOrdersBody> {
  @override
  void initState() {
    super.initState();
   context.read<ServiceOrderCubit>().getMyServiceOrder(isProvider: widget.isProvider);
  }
  @override
  Widget build(BuildContext context) {
    final  isLoadingStatus = context.watch<ServiceOrderCubit>().isLoadingStatus;
    final  isAccepted = context.watch<ServiceOrderCubit>().isAccepted;
     final  isLoading = context.watch<ServiceOrderCubit>().isServiceOrderLoading;
     final ServiceOrdersModel? serviceOrdersModel = context.watch<ServiceOrderCubit>().serviceOrdersModel;
                             ...
                             Row(
                               children: [
                                 Expanded(child: CustomButton(
                                   ...
                                   height: 37,
                                   onTap: (){
                                     context.read<ServiceOrderCubit>().changeStatusServiceOrder(isAccepted: true,id: data?.id??0);
                                   },
                                 ...
                                 Expanded(child: CustomButton(
                                   ...
                                   onTap: (){
                                     context.read<ServiceOrderCubit>().changeStatusServiceOrder(isAccepted: false,id: data?.id??0);
