...
class _$AddReplayComment extends AddReplayComment {
  @override
  final OnReply onReply;
  @override
  final int repliedUserId;

  factory _$AddReplayComment(
          [void Function(AddReplayCommentBuilder)? updates]) =>
      (new AddReplayCommentBuilder()..update(updates))._build();

  _$AddReplayComment._({required this.onReply, required this.repliedUserId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        onReply, r'AddReplayComment', 'onReply');
    BuiltValueNullFieldError.checkNotNull(
        repliedUserId, r'AddReplayComment', 'repliedUserId');
  }

  @override
  AddReplayComment rebuild(void Function(AddReplayCommentBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AddReplayCommentBuilder toBuilder() =>
      new AddReplayCommentBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    final dynamic _$dynamicOther = other;
    return other is AddReplayComment &&
        onReply == _$dynamicOther.onReply &&
        repliedUserId == other.repliedUserId;
  }
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, onReply.hashCode);
    _$hash = $jc(_$hash, repliedUserId.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AddReplayComment')
          ..add('onReply', onReply)
          ..add('repliedUserId', repliedUserId))
        .toString();
  }
...
class AddReplayCommentBuilder
    implements Builder<AddReplayComment, AddReplayCommentBuilder> {
  _$AddReplayComment? _$v;

  OnReply? _onReply;
  OnReply? get onReply => _$this._onReply;
  set onReply(OnReply? onReply) => _$this._onReply = onReply;
  ...
  AddReplayCommentBuilder();

  AddReplayCommentBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _onReply = $v.onReply;
      _repliedUserId = $v.repliedUserId;
  ...
  @override
  void replace(AddReplayComment other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$AddReplayComment;
  }

  @override
  void update(void Function(AddReplayCommentBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AddReplayComment build() => _build();

  _$AddReplayComment _build() {
    final _$result = _$v ??
        new _$AddReplayComment._(
          onReply: BuiltValueNullFieldError.checkNotNull(
              onReply, r'AddReplayComment', 'onReply'),
          repliedUserId: BuiltValueNullFieldError.checkNotNull(
              repliedUserId, r'AddReplayComment', 'repliedUserId'),
        );
    replace(_$result);
    return _$result;
