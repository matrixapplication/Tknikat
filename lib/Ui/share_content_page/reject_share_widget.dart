...
import 'package:taknikat/Ui/report_page/bloc/report_state.dart';
...
class RejectShareWidget extends StatefulWidget {
  RejectShareWidget({Key? key, required this.modelId, required this.modelType})
      : super(key: key);
  final String modelType;
  final String modelId;

  @override
  State<RejectShareWidget> createState() => _RejectShareWidgetState();
}

class _RejectShareWidgetState extends State<RejectShareWidget> {
