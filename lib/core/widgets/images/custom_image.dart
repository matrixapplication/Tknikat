// import 'dart:io';
//
// import 'package:q_taxi_captain/core/extensions/num_extensions.dart';
// import 'package:cached_network_image/cached_network_image.dart';
//
// import 'package:flutter/material.dart';
// import 'package:flutter_svg/svg.dart';
// import 'package:q_taxi_captain/core/resources/decoration.dart';
//
...
//         child: Container(
//           decoration: const BoxDecoration().listStyle().borderStyle(color: error!=null?Theme.of(context).errorColor:Theme.of(context).hintColor,width: showBorder?1:0).customRadius(borderRadius: borderRadius ?? BorderRadius.all(Radius.circular(radius.r))),
